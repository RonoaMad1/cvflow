    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <main className="max-w-4xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <Link to="/dashboard/kanban" className="p-6 bg-slate-800 rounded-2xl border border-slate-700 hover:border-emerald-500 transition group">
            <div className="text-3xl mb-3">📋</div>
        ...
        <Link to="/dashboard/pipeline" className="p-6 bg-slate-800 rounded-2xl border border-slate-700 hover:border-emerald-500 transition group">
          <div className="text-3xl mb-3">🎯</div>
          <h2 className="text-xl font-bold mb-2 group-hover:text-emerald-400 transition">Career Pipeline</h2>
          <p className="text-slate-400 text-sm">Offres scrapées automatiquement, scorées par IA et organisées par priorité</p>
        </Link>
